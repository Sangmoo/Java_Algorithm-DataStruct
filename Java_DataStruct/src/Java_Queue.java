...
public class Java_Queue {
    ...
    //초기화
    public void Java_Queue_Init(){this.Create();}
    //파괴
    public void Java_Queue_Destroy(){this.Destroy();}
    //큐 읽기
    ...
    public static void main(String[] args){
        Java_Queue Java_Queue = new Java_Queue();
        int Position;
        String Data;
        ...
        while(true){
            ...
            switch(Select){
                ...
                case 3:
                    ...
                    Java_Queue.Java_Queue_Init();
                    break;
                // 길이 기능
                case 4:
                    Java_Queue.Java_Queue_Destroy();
                    break;
                case 5:
                    Java_Queue.GetFront();
                    break;
                case 6:
                    Java_Queue.AllRetrieve();
                    break;
